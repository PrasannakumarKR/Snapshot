...
const Food = () => {
  ...
  const fetchPhotoData = () => {
    axios(`https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=${apiKey}&tags=${search}${place}&per_page=55&extras=${size}&format=json&nojsoncallback=1`)
